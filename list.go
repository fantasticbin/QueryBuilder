...
func NewList[R any, F any, S any]() *List[R, F, S] {
	return &List[R, F, S]{}
}
...
func (l *List[R, F, S]) SetDataSource(ds DataSource) *List[R, F, S] {
	l.dataSource = ds
	return l
}
...
func (l *List[R, F, S]) SetQuerier(querier Querier[R]) *List[R, F, S] {
	l.querier = querier
	return l
}
...
func (l *List[R, F, S]) SetScope(scope ScopeConfigurer[R]) *List[R, F, S] {
	l.scope = scope
	return l
}
