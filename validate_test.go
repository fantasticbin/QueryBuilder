...
func TestValidateData_LimitValid_Gorm(t *testing.T) {
	...
	// 使用中间件短路，避免真实数据库查询
	g.Use(func(ctx context.Context, builder Querier[ValidateTestEntity], next func(context.Context) ([]*ValidateTestEntity, int64, error)) ([]*ValidateTestEntity, int64, error) {
		return []*ValidateTestEntity{}, 0, nil
	})
	...
	g2.Use(func(ctx context.Context, builder Querier[ValidateTestEntity], next func(context.Context) ([]*ValidateTestEntity, int64, error)) ([]*ValidateTestEntity, int64, error) {
		return []*ValidateTestEntity{}, 0, nil
	})
	_, _, err = g2.QueryList(context.Background())
	if err != nil {
	...
	g3.SetLimit(5000)
	g3.Use(func(ctx context.Context, builder Querier[ValidateTestEntity], next func(context.Context) ([]*ValidateTestEntity, int64, error)) ([]*ValidateTestEntity, int64, error) {
		return []*ValidateTestEntity{}, 0, nil
	})
	_, _, err = g3.QueryList(context.Background())
	if err != nil {
...
func TestValidateData_LimitValid_Mongo(t *testing.T) {
	m := NewMongoBuilder[ValidateTestEntity](NewDBProxy(nil, &mongo.Collection{}, nil))
	m.Use(func(ctx context.Context, builder Querier[ValidateTestEntity], next func(context.Context) ([]*ValidateTestEntity, int64, error)) ([]*ValidateTestEntity, int64, error) {
		return []*ValidateTestEntity{}, 0, nil
	})
	...
	m2.SetLimit(5000)
	m2.Use(func(ctx context.Context, builder Querier[ValidateTestEntity], next func(context.Context) ([]*ValidateTestEntity, int64, error)) ([]*ValidateTestEntity, int64, error) {
		return []*ValidateTestEntity{}, 0, nil
	})
	_, _, err = m2.QueryList(context.Background())
	if err != nil {
		t.Errorf("limit=5000 should pass validation, got: %v", err)
	}
}
...
func TestValidateData_LimitValid_ES(t *testing.T) {
	e := NewElasticSearchBuilder[ValidateTestEntity](NewDBProxy(nil, nil, &elastic.Client{}), "test_index")
	e.Use(func(ctx context.Context, builder Querier[ValidateTestEntity], next func(context.Context) ([]*ValidateTestEntity, int64, error)) ([]*ValidateTestEntity, int64, error) {
		return []*ValidateTestEntity{}, 0, nil
	})
	...
	e2.SetLimit(5000)
	e2.Use(func(ctx context.Context, builder Querier[ValidateTestEntity], next func(context.Context) ([]*ValidateTestEntity, int64, error)) ([]*ValidateTestEntity, int64, error) {
		return []*ValidateTestEntity{}, 0, nil
	})
	_, _, err = e2.QueryList(context.Background())
	if err != nil {
		t.Errorf("limit=5000 should pass validation, got: %v", err)
	}
}
